...
const statusStyles = {
  ...
  Pendente: {
    background: "rgba(243, 243, 154, 0.842)",
    color: "rgb(194, 194, 0)",
  },
};
        ...
        <TableBody className="TableBody">
          {data.map((row, index) => (
            <TableRow key={index} style={{ alignItems: "center" }}>
              <TableCell style={{ width: "1px" }} className="Avatar1">
                <Avatar alt={`Foto de ${row.nome}`} src={row.perfil} />
              </TableCell>
              <TableCell style={{ textAlign: "center" }}>
                <span className="nome">{row.nome}</span>
              </TableCell>
              <TableCell style={{ textAlign: "center" }}>
                {row.assunto}
              </TableCell>
...
const ResumoTicket = () => {
  ...
  const data = [
    {
      perfil:
        "https://i.pinimg.com/236x/80/86/3a/80863aef9cf71d83e6c2f3abf96a6162.jpg",
      nome: "Carlos Oliveira",
      assunto: "Erro em tela",
      resp: "Patrícia",
      status: "Fechado",
      chamado: <button onClick={toggleModal}>Visualizar</button>,
    },
    {
      perfil:
        "https://i.pinimg.com/564x/92/0a/1f/920a1f9ce3f97307a96d81b8da464ec4.jpg",
      nome: "Pedro Santos",
      assunto: "Computador não liga",
      resp: "Marcos",
      status: "Aberto",
      chamado: <button>Visualizar</button>,
    },
    {
      perfil:
        "https://i.pinimg.com/564x/94/3a/e8/943ae8f26a559ff3d0aa1ebf7a9c02bb.jpg",
      nome: "Amanda Silva",
    ...
    {
      perfil:
        "https://i.pinimg.com/236x/9d/96/32/9d9632c13142954d11fb4d5c7430e463.jpg",
      nome: "Maria Souza",
      assunto: "Software indisponível",
      resp: "Não atribuído",
      status: "Pendente",
      chamado: <button>Visualizar</button>,
    },
    {
      perfil:
        "https://i.pinimg.com/564x/76/26/36/7626365dc4b612cbef511ac0b5509124.jpg",
      nome: "Ana Oliveira",
      assunto: "Computador não liga",
      resp: "Gabriel",
      status: "Aberto",
    ...
    {
      perfil:
        "https://i.pinimg.com/236x/cb/57/5a/cb575a492a659596bd12f60378a2dc5e.jpg",
    ...
    {
      perfil:
        "https://i.pinimg.com/236x/13/4a/8e/134a8e059aa9bd2e44043cc6044401ef.jpg",
      nome: "Lucas Silva",
      assunto: "Software indisponível",
      resp: "Juliana",
      status: "Fechado",
  ...
  return (
    <>
      <Filter
        ...
        filterType="status"
        options={["Aberto", "Fechado", "Pendente"]}
      />
      <Filter
        onFilterChange={handleFilterChange}
        filterType="solicitante"
        options={[
          "Carlos Oliveira",
          "Pedro Santos",
          "Amanda Silva",
      ...
      <Filter
        ...
        options={["Patrícia", "Marcos", "Não atribuído", "Gabriel", "Juliana"]}
      />
        ...
        <div className="modal">
          ...
          <div className="modal-content">
            <div className="modal-right-side">
              ...
              <div className="modal-perfil">
                <div className="foto-modal-perfil">
                  <img
                    src="https://i.pinimg.com/236x/80/86/3a/80863aef9cf71d83e6c2f3abf96a6162.jpg"
            ...
            <div className="modal-side-content">
              ...
              <p>
                Detalhe: Sapiente dolorum id maiores dolores? Illum pariatur
